...
export const volumes = [
  {
    ...
    promise: "O que fazer quando ele esfria ou some.",
    coverPath: "/images/astarte/covers/volume-01.webp",
  },
  {
    number: "02",
    title: "A Virada do Tabuleiro",
    promise: "Como parar de correr atrás e mudar o jogo.",
    coverPath: "/images/astarte/covers/volume-02.webp",
  },
  {
    number: "03",
    title: "O Arquivo Secreto dos Cafajestes",
    promise: "Por que ele mente, some e volta.",
    coverPath: "/images/astarte/covers/volume-03.webp",
  },
  {
    number: "04",
    title: "Os Gatilhos do Vínculo Profundo",
    promise: "Como aumentar o desejo e a ligação entre vocês.",
    coverPath: "/images/astarte/covers/volume-04.webp",
  },
  {
    number: "05",
    title: "O Xeque-Mate",
    promise: "Como fazer ele tomar uma atitude.",
    coverPath: "/images/astarte/covers/volume-05.webp",
  },
] as const;
...
export const bonus = {
  ...
  promise: "O que fazer quando você sente que colocou tudo a perder.",
...
export const faqItems = [
  ...
  },
  {
    ...
    a: "Sim. O pagamento é feito no ambiente seguro configurado para a compra.",
  },
] as const;
